        ...
        <form action="" onSubmit={handleSubmit}>
          ...
          <div className="inputGroup pb-4 pt-4">
            ...
            {Boolean(errors.name) && Boolean(touched.name) && (
              <p className='text-red-600 absolute'>{errors.name}</p>
            )}
          ...
          <div className="inputGroup pb-4 pt-4">
            ...
            {Boolean(errors.email) && Boolean(touched.email) && <p className='text-red-600 absolute'>{errors.email}</p>}
          </div>
          <div className="inputGroup pb-2 pt-4">
            ...
            {Boolean(errors.password) && Boolean(touched.password) && (<p className='text-red-600 absolute'>{errors.password}</p>)}
          </div>
          <div className="">
          ...
          <div className="inputGroup pb-5 pt-4">
            ...
            {Boolean(errors.confirmPassword) && Boolean(touched.confirmPassword) && (<p className='text-red-600 absolute'>{errors.confirmPassword}</p>)}
          </div>
          <div className="inputGroup pb-4 mb-3">
            <input name='profilepicture' type="file" className="block w-full text-sm text-slate-500
              ...
              onBlur={handleBlur}
            />
            {Boolean(errors.profilepicture) && Boolean(touched.profilepicture) && (<p className='text-red-600 absolute'>{errors.profilepicture}</p>)}
          </div>
